...
(function ($) {
  ...
  MDSlider.prototype = {
    ...
    init: function () {
      ...
      var slideClass = "";
      if (this.options.responsive) slideClass += " md-slide-responsive";
      if (this.options.fullwidth) slideClass += " md-slide-fullwidth";
      if (this.options.showBullet && this.options.posBullet)
        slideClass += " md-slide-bullet-" + this.options.posBullet;
      if (
        !this.options.showBullet &&
        this.options.showThumb &&
        this.options.posThumb
      )
      ...
      this.slideWidth = this.options.responsive
        ? this.slider.width()
        : this.options.width;
      this.slideHeight = this.options.height;
      this.slideItems = [];
      this.hasTouch = this.documentHasTouch();
      if (this.hasTouch) this.wrap.addClass("md-touchdevice");
      //
      ...
      if ($(".md-video", this.wrap).length > 0) {
        if (this.options.videoBox) {
          $(".md-video", this.wrap).mdvideobox({
            autoplayVideo: self.options.autoplayVideo,
          });
        } else {
          var videoCtrl = $(
            '<div class="md-video-control" style="display: none"></div>'
          );
          ...
          $(".md-video", this.wrap).click(function () {
            ...
            else video_ele.attr("src", $(this).attr("href"));
            var closeButton = $(
              '<a href="#" class="md-close-video" title="Close video"></a>'
            );
            ...
            if (self.arrowButton) {
              videoCtrl.append(
                '<div class="md-arrow"><div class="md-arrow-left"><span></span></div><div class="md-arrow-right"><span></span></div></div>'
              );
    ...
    eventClickLink: function () {
      $(".md-objects", this.slider)
        .off("click")
        .on("click", function () {
          if ($(this).attr("data-url")) window.open($(this).attr("data-url"));
        });
    ...
    initControl: function () {
      ...
      if (this.options.slideShow && this.options.showLoading) {
        var loadingDiv = $(
          '<div class="loading-bar-hoz loading-bar-' +
            this.options.loadingPosition +
            '"><div class="br-timer-glow" style="left: -100px;"></div><div class="br-timer-bar" style="width:0px"></div></div>'
        );
      ...
      if (this.options.styleBorder != 0) {
        var borderDivs =
          '<div class="border-top border-style-' +
          this.options.styleBorder +
          '"></div>';
        borderDivs +=
          '<div class="border-bottom border-style-' +
          this.options.styleBorder +
          '"></div>';
        if (!this.options.fullwidth) {
          borderDivs +=
            '<div class="border-left border-style-' +
            this.options.styleBorder +
            '"><div class="edge-top"></div><div class="edge-bottom"></div></div>';
          borderDivs +=
            '<div class="border-right border-style-' +
            this.options.styleBorder +
            '"><div class="edge-top"></div><div class="edge-bottom"></div></div>';
        }
      ...
      if (this.options.styleShadow != 0) {
        var shadowDivs =
          '<div class="md-shadow md-shadow-style-' +
          this.options.styleShadow +
          '"></div>';
      }
      // Next, preview arrow
      ...
      if (
        this.options.showBullet != false ||
        this.options.showNavigationLinks != false
      ) {
        ...
        for (var i = 0; i < this.numItem; i++) {
          ...
          if (this.options.showNavigationLinks) {
            tagLink =
              '<a href="#">' + this.slideItems[i].data("thumb-alt") + "</a>";
          }
          this.buttons.append(
            '<div class="md-bullet"  rel="' + i + '">' + tagLink + "</div>"
          );
        }
        if (this.options.showThumb) {
          ...
          for (var i = 0; i < this.numItem; i++) {
            ...
            if (thumbSrc) {
              ...
              } else thumbLeft = thumbW / 2 - 2;

              if (thumbType == "image")
                thumb = $("<img />")
                  .attr("src", thumbSrc)
                  .attr("alt", this.slideItems[i].data("thumb-alt"))
                  .css({
                    top: -(9 + thumbH) + "px",
                    left: -thumbLeft + "px",
                    opacity: 0,
              ...
              $("div.md-bullet:eq(" + i + ")", this.buttons)
                .append(thumb)
                .append(
                  '<div class="md-thumb-arrow" style="opacity: 0"></div>'
                );
            }
          }
          $("div.md-bullet", this.buttons).hover(
            function () {
        ...
        var thumbDiv = $(
          '<div class="md-thumb"><div class="md-thumb-container"><div class="md-thumb-items"></div></div></div>'
        ).appendTo(this.wrap);
        ...
        this.slider.bind("touchmove", function (event) {
          ...
          if (self.touchstart) {
            ...
            if (typeof self.isScrolling == "undefined") {
              self.isScrolling = !!(
                self.isScrolling ||
                Math.abs(pageY - self.slider.mouseY) >
                  Math.abs(pageX - self.slider.mouseX)
              );
            }
            if (self.isScrolling) {
    ...
    resizeThumbDiv: function () {
      if (this.slideThumb) {
        ...
        $("a.md-thumb-item", this.slideThumb).each(function () {
          if ($("img", $(this)).length > 0) {
            if ($("img", $(this)).css("borderLeftWidth"))
              thumbsWidth += parseInt(
                $("img", $(this)).css("borderLeftWidth"),
                10
              );
            if ($("img", $(this)).css("borderRightWidth"))
              thumbsWidth += parseInt(
                $("img", $(this)).css("borderRightWidth"),
                10
              );
            ...
            if ($("span", $(this)).css("borderLeftWidth"))
              thumbsWidth += parseInt(
                $("span", $(this)).css("borderLeftWidth"),
                10
              );
            if ($("span", $(this)).css("borderRightWidth"))
              thumbsWidth += parseInt(
                $("span", $(this)).css("borderRightWidth"),
                10
              );
        ...
        if (thumbsWidth > $(".md-thumb-container", thumbDiv).width()) {
          this.minThumbsLeft =
            $(".md-thumb-container", thumbDiv).width() - thumbsWidth;
          ...
          if (this.hasTouch) {
            ...
            this.slideThumb.bind("touchmove", function (event) {
              ...
              if (thumbTouch) {
                self.slideThumb.css(
                  "left",
                  thumbLeft + event.pageX - this.mouseX
                );
              }
              return false;
            });
            this.slideThumb.bind("touchend", function (event) {
              ...
              thumbTouch = false;
              if (
                Math.abs(event.pageX - this.mouseX) <
                self.options.touchSensitive
              ) {
                ...
                self.slideThumb
                  .stop(true, true)
                  .animate({ left: thumbLeft }, 400);
                return false;
              }
              if (self.slideThumb.position().left < self.minThumbsLeft) {
                self.slideThumb
                  .stop(true, true)
                  .animate({ left: self.minThumbsLeft }, 400, function () {
        ...
        if (position == "left") {
          ...
          if (thumbLeft > this.minThumbsLeft) {
            ...
            if (thumbLeft - containerWidth > this.minThumbsLeft) {
              ...
              this.slideThumb
                .stop(true, true)
                .animate({ left: this.minThumbsLeft }, 400, function () {
                  self.checkThumbArrow();
                });
            }
          }
          ...
          var thumbCurrent = $("a", this.slideThumb).index(
            $("a.md-current", this.slideThumb)
          );
          if (thumbCurrent >= 0) {
            var thumbLeft = this.slideThumb.position().left;
            ...
            if (currentLeft + thumbLeft < 0) {
              this.slideThumb
                .stop(true, true)
                .animate({ left: -currentLeft }, 400, function () {
                  self.checkThumbArrow();
                });
            } else {
              ...
              if (currentRight + thumbLeft > containerWidth) {
                this.slideThumb
                  .stop(true, true)
                  .animate(
                    { left: containerWidth - currentRight },
                    400,
                    function () {
                      self.checkThumbArrow();
                    }
    ...
    slide: function (index) {
      this.step = 0;
      this.slideShowDelay = this.slideItems[index].data("timeout")
        ? this.slideItems[index].data("timeout")
      ...
      var execeptItemClass =
        ".slide-" + (this.activeIndex + 1) + ", .slide-" + (this.oIndex + 1);
      $(".md-slide-item:not(" + execeptItemClass + ")", this.wrap).hide();

      if (this.slideItems[this.oIndex]) {
        $("div.md-bullet:eq(" + this.oIndex + ")", this.buttons).removeClass(
          "md-current"
        );
        $("a:eq(" + this.oIndex + ")", this.slideThumb).removeClass(
          "md-current"
        );
        ...
        if (this.options.transitions.toLowerCase() == "random") {
          ...
          fx =
            transitions[Math.floor(Math.random() * (transitions.length + 1))];
        ...
        if (this.slideItems[this.activeIndex].data("transition")) {
          var transitions = this.slideItems[this.activeIndex]
            .data("transition")
            .split(",");
          fx = transitions[Math.floor(Math.random() * transitions.length)];
          fx = $.trim(fx.toLowerCase());
        ...
        if (
          ...
          (fx == "slit-horizontal-left-top" ||
            fx == "slit-horizontal-top-right" ||
            fx == "slit-horizontal-bottom-up" ||
            fx == "slit-vertical-down" ||
            fx == "slit-vertical-up")
        ) {
          fx = "fade";
        }
        ...
        if (this.buttons)
          $(
            "div.md-bullet:eq(" + this.activeIndex + ")",
            this.buttons
          ).addClass("md-current");
        if (this.slideThumb)
          $("a:eq(" + this.activeIndex + ")", this.slideThumb).addClass(
            "md-current"
          );
        this.scollThumb();
        ...
        this.slideItems[this.activeIndex]
          .css({ top: 0, left: 0 })
          .show()
          .find("video[autoplay]")
          .trigger("load");
      ...
      this.timer = setInterval(function () {
        ...
        if (mdslide.play && !mdslide.pause) {
          ...
          if (mdslide.step > mdslide.slideShowDelay) {
            ...
            var width =
              (mdslide.step * mdslide.slideWidth) / mdslide.slideShowDelay;
      ...
      var easeout = caption.data("easeout") ? caption.data("easeout") : "",
        ieVersion =
          (!!window.ActiveXObject &&
            +/msie\s(\d+)/i.exec(navigator.userAgent)[1]) ||
          NaN;

      if (ieVersion != NaN) ieVersion = 11;
      else ieVersion = parseInt(ieVersion);
    ...
    animateTheCaptions: function (nextItem) {
      ...
      $(".md-object", nextItem).each(function (boxIndex) {
        var caption = $(this);
        if (caption.data("easeout")) caption.removeClass(effectsOut.join(" "));
        ...
        if (caption.data("start") != undefined) {
          caption.data(
            "timer-start",
            setTimeout(function () {
              if (easein != "" && ieVersion <= 9) caption.fadeIn();
              else caption.show().addClass(easein);
            }, caption.data("start"))
          );
        } else caption.show().addClass(easein);
      ...
      for (var i = 0; i < opts.strips; i++) {
        ...
        if (i == opts.strips - 1) {
          (width = vertical ? "0px" : this.slideWidth - stripWidth * i + "px"),
            (height = vertical
              ? this.slideHeight - stripHeight * i + "px"
              : "0px");
        } else {
    ...
    addTiles: function (x, y, index) {
      ...
      if ($image.length == 0) $image = $(".md-mainimg", this.slideItems[index]);
    ...
    addStrips2: function () {
      ...
      else images.push($(".md-mainimg", this.slideItems[this.activeIndex]));
    ...
    addSlits: function (fx) {
      var $stripsContainer = $(
          '<div class="md-strips-container ' + fx + '"></div>'
        ),
        $image =
          $(".md-mainimg img", this.slideItems[this.oIndex]).length > 0
            ? $(".md-mainimg img", this.slideItems[this.oIndex])
            : $(".md-mainimg", this.slideItems[this.oIndex]),
      ...
      $div2.append(
        $image.clone().css("top", position.top - this.slideHeight / 2 + "px")
      );
      if (fx == "slit-vertical-down" || fx == "slit-vertical-up")
        $div2 = $('<div class="mdslider-slit"/>').append(
          $image.clone().css("left", position.left - this.slideWidth / 2 + "px")
        );
    ...
    runTransition: function (fx) {
      ...
      switch (fx) {
        ...
        case "slit-vertical-up":
          ...
          var transitionProp = {
            transition:
              "all " + this.options.transitionsSpeed + "ms ease-in-out",
            "-webkit-transition":
              "all " + this.options.transitionsSpeed + "ms ease-in-out",
            "-moz-transition":
              "all " + this.options.transitionsSpeed + "ms ease-in-out",
        ...
        case "strip-up-left":
          ...
          var strips = $(".mdslider-tile", this.slider),
            timeStep =
              this.options.transitionsSpeed / this.options.stripCols / 2,
            speed = this.options.transitionsSpeed / 2;
          if (fx == "strip-up-right")
            strips = $(".mdslider-tile", this.slider).reverse();
          strips.css({
            height: "1px",
            bottom: "0px",
            top: "auto",
        ...
        case "strip-left-down":
          ...
          var strips = $(".mdslider-tile", this.slider),
            timeStep =
              this.options.transitionsSpeed / this.options.stripRows / 2,
            speed = this.options.transitionsSpeed / 2;
          if (fx == "strip-left-up")
            strips = $(".mdslider-tile", this.slider).reverse();
          strips.css({
        ...
        case "left-curtain":
          ...
          strips.each(function (i) {
            var strip = $(this);
            var width =
                i == _self.options.stripCols - 1
                  ? stripItemWidth.last
                  : stripItemWidth.normal,
              left =
                i == _self.options.stripCols - 1
                  ? _self.width - stripItemWidth.last
                  : width * i;
            ...
            setTimeout(function () {
              strip.animate(
                ...
                self.options.transitionsSpeed / 2,
                function () {
                  if (i == self.options.stripCols - 1) self.transitionEnd();
                }
              );
        ...
        case "top-curtain":
          ...
          strips.each(function (i) {
            var strip = $(this);
            var height =
                i == _self.options.stripRows - 1
                  ? stripItemHeight.last
                  : stripItemHeight.normal,
              top =
                i == _self.options.stripRows - 1
                  ? _self.height - stripItemHeight.last
                  : height * i;
    ...
    getWidthStripItem: function () {
      ...
      result.last =
        this.slideWidth - result.normal * (this.options.stripCols - 1);
      return result;
    },
    getHeightStripItem: function () {
      ...
      result.last =
        this.slideHeight - result.normal * (this.options.stripRows - 1);
      return result;
    },
    ...
    resizeWindow: function () {
      ...
      if (this.options.responsive) {
        if (this.options.fullwidth && this.slideWidth > this.options.width)
          ...
          this.slideHeight = Math.round(
            (this.slideWidth / this.options.width) * this.options.height
          );
      }
      ...
      if (
        ...
        this.wrap.width() < this.options.width
      )
    ...
    resizeBackgroundImage: function () {
      ...
      $(".md-slide-item", this.slider).each(function () {
        ...
        } else $(".md-mainimg", $(this)).width($(".md-slide-item:visible", self.slider).width()).height($(".md-slide-item:visible", self.slider).height());
      });
    },
    ...
    resizeFontSize: function () {
      ...
      if (this.wrap.width() < this.options.width) {
        $(".md-objects", this.slider).css({
          "font-size":
            (this.wrap.width() / this.options.width) * 100 - fontDiff + "%",
        });
      } else {
        $(".md-objects", this.slider).css({
          "font-size": 100 - fontDiff + "%",
        });
      }
    },
      ...
      if (this.wrap.width() < this.options.width && this.options.responsive) {
        $(".md-objects div.md-object", this.slider).each(function () {
          ...
          if ($_object.data("paddingtop"))
            objectPadding["padding-top"] =
              $_object.data("paddingtop") * objectRatio;
          if ($_object.data("paddingright"))
            objectPadding["padding-right"] =
              $_object.data("paddingright") * objectRatio;
          if ($_object.data("paddingbottom"))
            objectPadding["padding-bottom"] =
              $_object.data("paddingbottom") * objectRatio;
          if ($_object.data("paddingleft"))
            objectPadding["padding-left"] =
              $_object.data("paddingleft") * objectRatio;

          if ($("> a", $_object).length) {
            $("> a", $_object).css(objectPadding);
          } else $_object.css(objectPadding);
        });
      } else {
        $(".md-objects div.md-object", this.slider).each(function () {
          var $_object = $(this),
          ...
          if ($("> a", $_object).length) $("> a", $_object).css(objectPadding);
          else $_object.css(objectPadding);
        });
      }
    },
  ...
  ImagePreload.prototype = {
    ...
    OnComplete: function () {
      ...
      if (this.m_nProcessed == this.m_nICount) this.m_pfnFinished();
        ...
        this.m_pfnPercent(
          Math.round((this.m_nProcessed / this.m_nICount) * 10)
        );
    },
    OnLoad: function () {
      this.bLoaded = true;
    ...
    $(this).each(function () {
      function init() {
        if ($("#md-overlay").length == 0) {
          var _overlay = $('<div id="md-overlay" class="md-overlay"></div>')
            .hide()
            .click(closeMe);
          var _container = $(
            '<div id="md-videocontainer" class="md-videocontainer"><div id="md-video-embed"></div><div class="md-description clearfix"><div class="md-caption"></div><a id="md-closebtn" class="md-closebtn" href="#"></a></div></div>'
          );
          _container.css({
      ...
      function activate() {
        ...
        overlay
          .css("display", "block")
          .fadeTo("fast", options.defaultOverLayFade);
        caption.html(title);
      ...
      function insert() {
        ...
        embed =
          ...
          videoSrc +
          '" width="' +
          options.contentsWidth +
          '" height="' +
          options.contentsHeight +
      ...
      var element = $(this);
      var videoSrc = options.autoplayVideo
        ? element.attr("href") + "?autoplay=1"
        : element.attr("href");
